...
group('callback', function () {
  ...
  var callback = {
    callbackUrl: 'http://127.0.0.1:3333/index',
    callbackHost: '1',
  ...
  test('putObject callback error', function (done) {
    cos.putObject(
      ...
      function (err, data) {
        console.log('data.CallbackError', data.CallbackError);
        assert.ok(data.CallbackError);
        done();
      }
    );
  });
  test('sliceUploadFile callback error', function (done) {
    cos.sliceUploadFile(
      {
        Bucket: config.Bucket,
        Region: config.Region,
...
//     );
//   });
//   test('sliceUploadFile returnBody error', function (done) {
//     cos.sliceUploadFile(
//       {
//         Bucket: config.Bucket,
//         Region: config.Region,
...
//     );
//   });
//   test('putObject returnBody', function (done) {
//     cos.putObject(
//       {
//         Bucket: config.Bucket,
//         Region: config.Region,
...
//       },
//       function (err, data) {
//         assert.ok(data.ReturnBody.filesize);
//         done();
//       }
//     );
//   });
//   test('sliceUploadFile returnBody', function (done) {
//     cos.sliceUploadFile(
//       {
//         Bucket: config.Bucket,
//         Region: config.Region,
